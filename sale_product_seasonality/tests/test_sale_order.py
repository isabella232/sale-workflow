...
class TestSaleOrderCase(CommonCase):
            ...
            [
                {
                    ...
                    "date_end": fields.Datetime.to_datetime("2021-05-21 11:20:00"),
                }
            ],
        )
            ...
            [
                {
                    ...
                    "date_end": fields.Datetime.to_datetime("2021-06-05 14:25:00"),
                }
            ],
        )
    ...
    def test_onchange_dates(self):
        ...
        # date_end default
        self.assertEqual(
            form.date_end, fields.Datetime.to_datetime("2021-05-30 10:15:00")
        )
        # date_end change rounding
        form.date_end = "2021-06-05 14:24:05"
        self.assertEqual(
            form.date_end, fields.Datetime.to_datetime("2021-06-05 14:25:00")
        )
