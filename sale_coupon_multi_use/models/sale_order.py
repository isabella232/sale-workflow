...
class SaleOrder(models.Model):
    ...
    def _get_valid_applied_coupon_program(self):
        ...
        multi_use_programs = self.coupon_multi_use_ids.mapped("program_id")
        applied_multi_use_programs = (
            multi_use_programs._filter_programs_from_common_rules(self)
        )
        return programs | applied_multi_use_programs
