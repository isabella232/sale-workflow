...
class SaleCouponProgram(models.Model):
    ...
    def write(self, vals):
        for program in self:
            if vals.get("discount_line_product_chosen", program.discount_line_product_chosen):
            ...
            if current_product_name and program.discount_line_product_id.name != current_product_name:
