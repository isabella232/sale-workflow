...
class BlanketOrderLine(models.Model):
    ...
    margin_percent = fields.Float("Margin (%)", compute="_compute_margin", store=True, group_operator="avg", groups="base.group_user")
    purchase_price = fields.Float("Cost", compute="_compute_purchase_price", digits="Product Price", store=True, readonly=False, groups="base.group_user")
    ...
    def _compute_margin(self):
        for line in self:
            line.margin = line.price_subtotal - (line.purchase_price * line.original_uom_qty)
